						...
						<tr>
							...
							<td class="tableContent">
								<select name="tradeTerms">
									<option>T/T(电汇)</option>
									<option>L/C(远期信用)</option>
									<option>CIF(成本保险费加运费)</option>
									<option selected="selected">FOB(船上交货)</option>
									<option>FAS(船边交货)</option>
									<option>FCA(货交承运人)</option>
									<option>EXW(工厂交货)</option>
									<option>DEQ(目的港码头交货)</option>
									<option>DES(目的港船上交货)</option>
									<option>DDP(完税后交货)</option>
									<option>DAF(边境交货)</option>
								</select>
							</td>
