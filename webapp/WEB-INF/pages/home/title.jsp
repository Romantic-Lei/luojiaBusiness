...
setInterval(function(){
	  ...
	  box.innerHTML=year+"/"+month+"/"+day+"/ "+hour+":"+minite+":"+second+" "+week;		  
...
<body onSelectStart="return true">
	...
	<div id="userInfo" style="z-index: 999;" onclick="HideLoginDiv()"
		...
		<img src="${ctx}/skin/default/images/title/avataronline.gif"
			border="0" style="margin-top: -1px;" /> 您好：<strong><font
			color="#8d1ec3" size="2px">${name} </font></strong>&nbsp;&nbsp;|
		&nbsp;&nbsp;您所属单位：<strong title="${dept}"><font
			color="#8d1ec3" size="2px">${dept}</font>&nbsp;&nbsp;|
			&nbsp;&nbsp;登录ip：<strong><font color="#8d1ec3" size="2px">
					${ip} </font></strong></strong>&nbsp;&nbsp; <img
			src="${ctx}/skin/default/images/title/close.gif" border="0" />
	</div>
	...
	<a id="logout" style="cursor: pointer;" href="${ctx}/logout.action"
		target="_top" title="点击退出系统"><div id="small_login_out"
			class="small_login_out" title="点击退出系统"></div></a>
	...
	<div class="headerBg">
		...
		<div class="top_logo">
			...
			<div class="navMenu" style="float: left; text-align: left;">
				...
				<div id="time"></div>
					<%-- <fmt:formatDate value="${now}" pattern="yyyy年M月d日H时E" /> --%>
				</div>
					...
					<div id="mask">
						<div id="menuContent">
							<span id="topmenu"
								...
								id="tm_separator"></span><span id="topmenu"
								onclick="top.leftFrame.location.href='sysadminLeft.action';top.main.location.href='sysadminMain.action';linkHighlightMenu(this);">系统管理</span><span
								id="tm_separator"></span><span  id="topmenu"
								onclick="javascript:window.open('http://127.0.0.1:8080/qq','_blank')">珞珈之家</span>
						</div>
					</div>
				</div>
			</div>
